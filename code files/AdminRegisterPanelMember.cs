...
namespace Final_prj
{
    public partial class AdminRegisterPanelMember : Form
    {
        ...
        public AdminRegisterPanelMember()
        {
            InitializeComponent();
        }

        private void AdminRegisterPanelMember_Load(object sender, EventArgs e)
        {

        }

        private void txtPMName_TextChanged(object sender, EventArgs e)
        {

        }

        private void txtPMUserName_TextChanged(object sender, EventArgs e)
        {

        }

        private void txtPMEmail_TextChanged(object sender, EventArgs e)
        {

        }

        private void txtPMPassword_TextChanged(object sender, EventArgs e)
        {
        ...
        private void txtPMDOB_TextChanged(object sender, EventArgs e)
        {
